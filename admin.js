...
function buildReceiptHTML(s) {
  ...
  document.getElementById('receiptContent').innerHTML=`
    <div style="background:#0d1f35;padding:32px 36px;display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:12px;">
      ...
      <div style="text-align:right;">
        ...
        <div style="font-size:.79rem;color:#7a9ab8;margin-top:4px;"><i class="fa-regular fa-calendar"></i> Issued: ${date}</div>
    ...
    <div style="padding:14px 36px;display:flex;align-items:center;justify-content:space-between;gap:10px;background:#f9f8f5;border-bottom:1px solid #ebe8df;">
      <div><div style="font-size:.64rem;text-transform:uppercase;letter-spacing:1px;color:#888;margin-bottom:3px;"><i class="fa-solid fa-circle-dot" style="color:#e8820c;"></i> Origin</div>
      ...
      <div style="text-align:right;"><div style="font-size:.64rem;text-transform:uppercase;letter-spacing:1px;color:#888;margin-bottom:3px;">Destination</div>
    ...
    <div style="padding:20px 36px;border-bottom:1px solid #ebe8df;">
      <div style="font-size:.64rem;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#e8820c;margin-bottom:14px;padding-bottom:6px;border-bottom:2px solid #e8820c;"><i class="fa-solid fa-route"></i> Shipment Progress</div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;">
      <div style="padding:22px 26px;border-right:1px solid #ebe8df;border-bottom:1px solid #ebe8df;">
        <div style="font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#e8820c;margin-bottom:10px;padding-bottom:5px;border-bottom:2px solid #e8820c;"><i class="fa-solid fa-user"></i> Sender</div>
      ...
      <div style="padding:22px 26px;border-bottom:1px solid #ebe8df;">
        <div style="font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#e8820c;margin-bottom:10px;padding-bottom:5px;border-bottom:2px solid #e8820c;"><i class="fa-solid fa-user-check"></i> Recipient</div>
        <div style="font-size:.87rem;display:flex;flex-direction:column;gap:7px;">
      ...
      <div style="padding:22px 26px;border-right:1px solid #ebe8df;">
        <div style="font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#e8820c;margin-bottom:10px;padding-bottom:5px;border-bottom:2px solid #e8820c;"><i class="fa-solid fa-box"></i> Package</div>
        <div style="font-size:.87rem;display:flex;flex-direction:column;gap:7px;">
      ...
      <div style="padding:22px 26px;">
        <div style="font-size:.62rem;font-weight:700;text-transform:uppercase;letter-spacing:2px;color:#e8820c;margin-bottom:10px;padding-bottom:5px;border-bottom:2px solid #e8820c;"><i class="fa-solid fa-truck"></i> Delivery</div>
        <div style="font-size:.87rem;display:flex;flex-direction:column;gap:7px;">
    ...
    <div style="background:#0d1f35;padding:20px 36px;display:flex;justify-content:space-between;align-items:center;">
      <div><div style="font-size:.74rem;color:#7a9ab8;text-transform:uppercase;letter-spacing:1px;">Total Shipping Cost</div></div>
      <div style="font-size:2rem;font-weight:800;color:#e8820c;">${s.cost?'$'+parseFloat(s.cost).toFixed(2):'Contact Us'}</div></div>
    ${s.notes?`<div style="padding:14px 36px;background:#fffbf5;border-top:2px solid #e8820c;font-size:.87rem;color:#5a6a7a;"><i class="fa-solid fa-note-sticky" style="color:#e8820c;"></i> <strong style="color:#0d1f35;">Notes:</strong> ${s.notes}</div>`:''}
    <div style="background:#f9f8f5;padding:20px 36px;text-align:center;border-top:1px solid #ebe8df;font-size:.79rem;color:#7a8a9a;line-height:2.2;">
      ...
      <i class="fa-solid fa-envelope"></i> info@zipcargo.com &nbsp;&bull;&nbsp; <i class="fa-solid fa-globe"></i> www.zipcargo.com<br/>
      <em>Ship Smarter. Deliver Faster. — Thank you for your business.</em></div>`;

  const qrId = 'qr_'+s.tracking.replace(/[^a-zA-Z0-9]/g,'_');
  const qrWrap = document.createElement('div');
  qrWrap.style = 'padding:16px 36px;display:flex;justify-content:center;background:white;';
  qrWrap.innerHTML = `<div id="${qrId}" style="text-align:center;"><div style="font-size:.68rem;color:#999;margin-bottom:8px;">Scan to verify</div></div>`;
  document.getElementById('receiptContent').appendChild(qrWrap);

  function loadQR(){
    new QRCode(document.getElementById(qrId),{
      text:s.tracking, width:80, height:80, colorDark:'#0d1f35', colorLight:'#ffffff',
  ...
  if(window.QRCode){ loadQR(); }
    ...
    sc.onload=loadQR; document.head.appendChild(sc);
  }
}
